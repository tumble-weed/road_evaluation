...
if [ $purge = true ]; then
    if [ $retrain = true ]; then
        ...
        python utils.py --result_file="./result/retrain${flag_stub}.json"
        python utils.py --result_file="./result/retrain${flag_stub}_details.json"
    else
        echo "purging noretrain"
        python utils.py --result_file="./result/noretrain${flag_stub}.json"
        python utils.py --result_file="./result/noretrain${flag_stub}_details.json"
    fi
fi
#=======================================================
# Actual run
